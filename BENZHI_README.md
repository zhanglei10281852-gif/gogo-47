...
- 项目：zhanglei10281852-gif/gogo-47
...
./build_benzhi_docker.sh benzhi-task-47-amd64 linux/amd64
./build_benzhi_docker.sh benzhi-task-47-arm64 linux/arm64
docker run -it benzhi-task-47-amd64:latest
docker run -it --platform linux/arm64 benzhi-task-47-arm64:latest
```

## 题目验证命令

1. 预期退出码 0：`go test ./internal/ingest -run "^TestParseEpochPreservesSubsecondUnits$" -count=1 -v`
